...
- Screenshots for anything that changes the interface. Use the demo mode (`TG_DEMO_MODE=1`, see the
  README) rather than your own account, so no real conversation ends up in a public image.
